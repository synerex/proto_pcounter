...
func (*PCounter) Descriptor() ([]byte, []int) {
	return fileDescriptor_pcounter_17f2d8e97bf52110, []int{0}
}
...
func (*PEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_pcounter_17f2d8e97bf52110, []int{1}
}
...
func (*PCounters) Descriptor() ([]byte, []int) {
	return fileDescriptor_pcounter_17f2d8e97bf52110, []int{2}
}
...
func (*ACounter) Descriptor() ([]byte, []int) {
	return fileDescriptor_pcounter_17f2d8e97bf52110, []int{3}
}
...
type ACounters struct {
	Pcs                  []*ACounter `protobuf:"bytes,1,rep,name=pcs,proto3" json:"pcs,omitempty"`
...
func (*ACounters) Descriptor() ([]byte, []int) {
	return fileDescriptor_pcounter_17f2d8e97bf52110, []int{4}
}
...
func (m *ACounters) GetPcs() []*ACounter {
	if m != nil {
		return m.Pcs
	}
	return nil
...
func (*Retrieve) Descriptor() ([]byte, []int) {
	return fileDescriptor_pcounter_17f2d8e97bf52110, []int{5}
}
...
func init() { proto.RegisterFile("pcounter.proto", fileDescriptor_pcounter_17f2d8e97bf52110) }

var fileDescriptor_pcounter_17f2d8e97bf52110 = []byte{
	// 622 bytes of a gzipped FileDescriptorProto
	,
}
